...
from tvm_converter import TensorFlowLiteToTVMConverter
...
def create_dict_for_converter_tflite(args):
    dictionary = {
...
def main():
    ...
    try:
        converter = TensorFlowLiteToTVMConverter(create_dict_for_converter_tflite(args))
