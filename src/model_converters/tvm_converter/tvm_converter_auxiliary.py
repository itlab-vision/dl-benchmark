...
class Converter(metaclass=abc.ABCMeta):
    ...
    def get_converter(args):
        ...
        if framework == 'pytorch':
            return PyTorchToTVMConverter(args)
        elif framework == 'onnx':
            return ONNXToTVMConverter(args)
        elif framework == 'mxnet':
            return MXNetToTVMConverter(args)
        elif framework == 'tflite':
            return TensorFlowLiteToTVMConverter(args)
        elif framework == 'caffe':
            return CaffeToTVMConverter(args)
        elif framework == 'tvm':
            return TVMConverter(args)
