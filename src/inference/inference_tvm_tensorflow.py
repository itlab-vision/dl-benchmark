...
from src.model_converters.tvm_converter.tvm_converter import Converter  # noqa: E402
from src.model_converters.tf2tflite.tensorflow_common import load_model, get_input_operation_name  # noqa: E402
...
def create_dict_for_converter_tensorflow(args):
    dictionary = {
...
class TensorFlowToTVMConverter(Converter):
    ...
    def _convert_model_from_framework(self, target, dev):
        ...
        model, params = tvm.relay.frontend.from_tensorflow(model_tf, shape=shape_dict)
        return model, params
...
def main():
    ...
    try:
        ...
        converter = TensorFlowToTVMConverter(create_dict_for_converter_tensorflow(args))
