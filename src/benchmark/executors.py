...
class docker_executor(executor):
    ...
    def get_infrastructure(self):
        ...
        output =  self.my_container_dict[self.my_target_framework].exec_run(command_line,
    ...
    def execute_process(self, command_line):
        ...
        return self.my_container_dict[self.my_target_framework].exec_run(command_line,
            tty=True, privileged=True)
