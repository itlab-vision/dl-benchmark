...
- **Среднее количество кадров, обрабатываемое за секунду(frames per second, FPS)** -
  отношение полного количества обработанных изображений к полному времени инференса
...
- **Среднее количество кадров, обрабатываемых за секунду (frames per second, FPS)** -
