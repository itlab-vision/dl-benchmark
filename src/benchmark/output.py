class output_handler():
    ...
    def __create_table_row(self, test, executor, process):
    ...
    def add_row_to_table(self, test, executor, process):
        report_row = self.__create_table_row(test, executor, process)
        with open(self.__table_name, 'w') as table:
