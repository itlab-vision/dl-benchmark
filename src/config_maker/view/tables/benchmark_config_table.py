from tags import (CONFIG_MODEL_TAG, CONFIG_DATASET_TAG, CONFIG_FRAMEWORK_TAG, CONFIG_BATCH_SIZE_TAG,
                  CONFIG_DEVICE_TAG, CONFIG_ITERATION_COUNT_TAG, CONFIG_TEST_TIME_LIMIT_TAG,
                  CONFIG_FRAMEWORK_DEPENDENT_TAG, CONFIG_MODE_TAG,
