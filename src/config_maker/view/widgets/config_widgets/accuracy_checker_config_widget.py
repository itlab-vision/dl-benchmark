...
from view.dialogs.accuracy_checker_config_dialog import AccuracyCheckerConfigDialog
from view.tables.accuracy_checker_config_table import AccuracyCheckerConfigTable
