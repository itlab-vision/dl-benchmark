...
from tags import CONFIG_TESTS_TAG, CONFIG_TEST_TAG, CONFIG_MODEL_TAG, CONFIG_DATASET_TAG
...
class BenchmarkConfig:
    ...
    def add_test(self, model, dataset, framework, batch_size, device, iter_count, test_time_limit, *args):
        self.__tests.append(Test(model, dataset, framework, batch_size, device, iter_count, test_time_limit, *args))

    def change_test(self, row, model, dataset, framework, batch_size, device, iter_count, test_time_limit, *args):
        self.__tests[row] = Test(model, dataset, framework, batch_size, device, iter_count, test_time_limit, *args)
