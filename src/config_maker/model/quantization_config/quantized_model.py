...
from tags import (CONFIG_MODEL_PARAMS_MODEL_TAGS, HEADER_POT_PARAMS_TAGS, HEADER_MODEL_PARAMS_MODEL_TAGS,
                  HEADER_MODEL_PARAMS_ENGINE_TAGS, CONFIG_MODEL_TAG, CONFIG_ENGINE_TAG, CONFIG_COMPRESSION_TAG,
                  CONFIG_POT_PARAMETERS_TAG, CONFIG_Q_CONFIG_TAG, CONFIG_MODEL_PARAMETERS_TAG, CONFIG_MODEL_NAME_TAG,
                  CONFIG_WEIGHTS_TAG, CONFIG_STAT_REQUESTS_NUMBER_TAG, CONFIG_EVAL_REQUESTS_NUMBER_TAG,
                  CONFIG_CONFIG_TAG, CONFIG_CONFIG_TYPE_TAG, CONFIG_DATA_SOURCE_TAG, CONFIG_CONFIG_ID_TAG)
