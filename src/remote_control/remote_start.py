...
def cli_parser():
    ...
    parser.add_argument('-l', '--server_login',
                        type=str,
                        help='Login to FTP server',
                        required=True)
    parser.add_argument('-p', '--server_psw',
                        type=str,
                        help='Password to FTP server',
                        required=True)
    parser.add_argument('-br', '--benchmark_result_table',
                        type=str,
                        help='Name of benchmark result table',
                        required=False)
    parser.add_argument('-acr', '--accuracy_checker_result_table',
                        type=str,
                        help='Name of accuracy checker result table',
                        required=False)
