class DeployConfigPresenter:
    ...
    def __handle_add_button(self, ip, login, password, os, download_folder):
    ...
    def __handle_change_button(self, row, ip, login, password, os, download_folder):
