...
def download_dgl_models(output_dir: Path = OUTPUT_DIR):
    ...
    dgl_pt_link = ('https://raw.githubusercontent.com/itlab-vision/dgl/main/models/gcn_model.pt')
    download_file(dgl_pt_link, dgl_dir, 'gcn_model.pt')

    dgl_py_link = ('https://raw.githubusercontent.com/itlab-vision/dgl/main/models/GCN.py')
