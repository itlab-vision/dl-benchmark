...
curl -o working_dir_smoke/dgl/model.pt https://raw.githubusercontent.com/Atikin-NT/dgl-test/main/model.pt
curl -o working_dir_smoke/dgl/GCN.py https://raw.githubusercontent.com/Atikin-NT/dgl-test/main/GCN.py
