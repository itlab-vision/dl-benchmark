...
python3 ../../../src/model_converters/tvm_converter/pytorch_to_tvm_converter.py -mn efficientnet_b0 -w public/efficientnet-b0-pytorch/efficientnet-b0.pth -is 1 3 224 224
cd ../

result_file="results_benchmark.csv"
[ -f $result_file ] && rm $result_file
smoke_config_file="my_tests.xml"
